...
weight_gray=0.05
"""
def create_dataset(json_filename, labeled, smooth_rgb=0.2, smooth_gray=0.5,
                   weight_rgb=0.10, weight_gray=0.10):
...
def main():
    ...
    common_model = train_models(args,(y_train, X_b, X_images), 8e-05, args.batch_size, 250, 1, return_model=True)
